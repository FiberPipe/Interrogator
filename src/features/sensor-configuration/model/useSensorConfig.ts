...
import { createEmptySensor, type SensorConfig, type SensorType } from '../../../entities/sensor/model/types';
...
export const useSensorConfig = () => {
    ...
    const saveConfiguration = useCallback(async () => {
        ...
        try {
            ...
            addSuccessToaster(
                t('sensors.messages.saved'),
                t('sensors.messages.savedDescription')
            );
        } catch (err) {
