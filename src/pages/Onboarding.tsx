...
export default function Onboarding({ setIsFirstLaunch }: OnboardingProps) {
    ...
    return (
        <div className="w-full h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 via-background to-secondary-50 dark:from-gray-900 dark:via-background dark:to-gray-800 p-4">
            <motion.div
                        ...
                        <div className="relative overflow-hidden min-h-[300px]">
                            <AnimatePresence mode="wait" custom={direction}>
                                ...
                                >
                                    ...
                                    {step === 2 && <PortStep onBack={back} onFinish={finish} />}
                                </motion.div>
                            </AnimatePresence>
                        </div>
                    </CardBody>
